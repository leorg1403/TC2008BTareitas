    ...
    def __init__(self, width=50, height=50, initial_fraction_alive=0.2, seed=None):
        ...
        for cell in self.grid.all_cells:
            Cell(
                ...
                init_state=(
                    Cell.ALIVE
                    if self.random.random() < initial_fraction_alive and cell.coordinate[1] == height - 1
                    else Cell.DEAD # Con el height -1 se verifica que solo se vaya a inicializar la primera fila
                ),
            )
