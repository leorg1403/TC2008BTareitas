from random_agents.randomagentes import RandomAgent, ObstacleAgent, ChargingStationAgent, TrashAgent
from random_agents.modelagentsvarios import RandomModel
